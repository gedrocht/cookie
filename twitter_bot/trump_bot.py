...
CONSUMER_KEY = 'y8NWZkyK42tHeLlCJRg6YIJko'#keep the quotes, replace this with your consumer key
CONSUMER_SECRET = 'bPCuFETlESyEiFM62X2t0KrEMyVQmoB9yn1vIybbHsL10ogeFV'#keep the quotes, replace this with your consumer secret key
ACCESS_KEY = '822960701388062721-Kr332OLSCgjLwIDhCSoMIdvN8fowdq3'#keep the quotes, replace this with your access token
ACCESS_SECRET = 'GiGJtM3K2FA9q85Ux3s8XhgidF6Wu0WIV4fwzJWVOWI6e'#keep the quotes, replace this with your access token secret
...
filename=open("trump_bot_data.text",'r')
f=filename.readlines()
filename.close()
